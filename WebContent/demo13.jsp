...
<body>
	...
	<div id="myDIV">
		<p>This div element has an onmousemove event handler that displays
			a random number every time you move your mouse inside this orange
			field.</p>
	...
	<script type="text/javascript">
		...
		function mul(a, b) {
			...
			document.getElementById("product").innerHTML = f1 * f2;
		}
